...
@Autonomous(name = "DetectSkystonesTB1", group = "Autonomous")
@Disabled
public class DetectSkystones extends LinearOpMode {
    ...
    public static float offsetX = 0.5f / 8f; //Public to change based on red or blue but that DIDNt work so were gonna do something else
    ...
    private static String skystonePos = "unknown";
